                    ...
                    <div className="ab-info-grids">
                        ...
                        <div id="products" className="row view-group">
                            ...
                            <div className="item col-lg-4">
                                <div className="thumbnail card">
                                    <div className="img-event">
                                        <img className="group list-group-image img-fluid" src="../assets/images/img5.jpg" alt="" />
                                    </div>
                                    <div className="caption card-body">
                                        <h4 className="group card-title inner list-group-item-heading">
                                            Blog Post 2</h4>
                            ...
                            <div className="item col-lg-4">
                                <div className="thumbnail card">
                                    <div className="img-event">
                                        <img className="group list-group-image img-fluid" src="../assets/../assets/images/img3.jpg" alt="" />
                                    </div>
                                    <div className="caption card-body">
                                        <h4 className="group card-title inner list-group-item-heading">
                                            Blog Post 3</h4>
                            ...
                            <div className="item col-lg-4 mt-lg-4">
                                <div className="thumbnail card">
                                    <div className="img-event">
                                        <img className="group list-group-image img-fluid" src="../assets/images/img4.jpg" alt="" />
                                    </div>
                                    <div className="caption card-body">
                                        <h4 className="group card-title inner list-group-item-heading">
                                            Blog Post 4</h4>
                            ...
                            <div className="item col-lg-4 mt-lg-4">
                                <div className="thumbnail card">
                                    <div className="img-event">
                                        <img className="group list-group-image img-fluid" src="../assets/images/img6.jpg" alt="" />
                                    </div>
                                    <div className="caption card-body">
                                        <h4 className="group card-title inner list-group-item-heading">
                                            Blog Post 5</h4>
                            ...
                            <div className="item col-lg-4 mt-lg-4">
                                <div className="thumbnail card">
                                    <div className="img-event">
                                        <img className="group list-group-image img-fluid" src="../assets/images/img7.jpg" alt="" />
                                    </div>
                                    <div className="caption card-body">
                                        <h4 className="group card-title inner list-group-item-heading">
                                            Blog Post 6</h4>
